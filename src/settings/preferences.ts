...
const translations: Record<string, Record<TranslationKey, string>> = {
  "zh-CN": {
    ...
    "settings.current": "当前",
    "settings.aiInterface": "AI 接口配置",
    "settings.aiInterfaceDesc": "选择 AI 供应商并填写 API Key",
    "aiConfig.title": "AI 接口配置",
    "aiConfig.providerLabel": "供应商",
    "aiConfig.apiKeyLabel": "API Key",
    "aiConfig.baseUrlLabel": "接口地址",
    "aiConfig.modelLabel": "模型",
    "aiConfig.save": "保存",
    "aiConfig.savedToast": "AI 接口配置已保存",
    "aiConfig.apiKeyPlaceholder": "请输入 API Key",
    "aiConfig.baseUrlPlaceholder": "请输入接口地址",
    "aiConfig.modelPlaceholder": "请输入模型名称",
  ...
  "zh-TW": {
    ...
    "settings.current": "目前",
    "settings.aiInterface": "AI 介面設定",
    "settings.aiInterfaceDesc": "選擇 AI 供應商並填寫 API Key",
    "aiConfig.title": "AI 介面設定",
    "aiConfig.providerLabel": "供應商",
    "aiConfig.apiKeyLabel": "API Key",
    "aiConfig.baseUrlLabel": "介面網址",
    "aiConfig.modelLabel": "模型",
    "aiConfig.save": "儲存",
    "aiConfig.savedToast": "AI 介面設定已儲存",
    "aiConfig.apiKeyPlaceholder": "請輸入 API Key",
    "aiConfig.baseUrlPlaceholder": "請輸入介面網址",
    "aiConfig.modelPlaceholder": "請輸入模型名稱",
  ...
  "en-US": {
    ...
    "settings.aiInterface": "AI Interface",
    "settings.aiInterfaceDesc": "Choose AI provider and enter API Key",
    "aiConfig.title": "AI Interface",
    "aiConfig.providerLabel": "Provider",
    "aiConfig.apiKeyLabel": "API Key",
    "aiConfig.baseUrlLabel": "Base URL",
    "aiConfig.modelLabel": "Model",
    "aiConfig.save": "Save",
    "aiConfig.savedToast": "AI config saved",
    "aiConfig.apiKeyPlaceholder": "Enter API Key",
    "aiConfig.baseUrlPlaceholder": "Enter base URL",
    "aiConfig.modelPlaceholder": "Enter model name",
  ...
  "ar-SA": {
    ...
    "settings.aiInterface": "واجهة الذكاء الاصطناعي",
    "settings.aiInterfaceDesc": "اختر مزود الذكاء الاصطناعي وأدخل API Key",
    "aiConfig.title": "واجهة الذكاء الاصطناعي",
    "aiConfig.providerLabel": "المزود",
    "aiConfig.apiKeyLabel": "API Key",
    "aiConfig.baseUrlLabel": "العنوان الأساسي",
    "aiConfig.modelLabel": "النموذج",
    "aiConfig.save": "حفظ",
    "aiConfig.savedToast": "تم حفظ الإعدادات",
    "aiConfig.apiKeyPlaceholder": "أدخل API Key",
    "aiConfig.baseUrlPlaceholder": "أدخل العنوان الأساسي",
    "aiConfig.modelPlaceholder": "أدخل اسم النموذج",
